...
gulp.task('app', function(){
  gulp.src([DESTINO + 'assets/libs.min.js',  MEDIA + 'layouts/home.js',  MEDIA + 'models/usuario.js', MEDIA + 'views/home.js', MEDIA + 'views/buscar.js', MEDIA + 'views/contacto.js',  MEDIA + 'views/registro.js', MEDIA + 'views/_form_registro.js', MEDIA + 'views/login.js',  MEDIA + 'routes/router.js'])
    //.pipe(uglify())
    .pipe(plumber())
